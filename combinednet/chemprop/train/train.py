...
def train(model: MoleculeModel,
    ...
    for batch in tqdm(data_loader, total=len(data_loader), leave=False):
        ...
        mol_batch, features_batch, target_batch, atom_descriptors_batch, atom_features_batch, bond_features_batch, add_feature = \
        ...
        # Run model
        model.zero_grad()
        add_feature = torch.from_numpy(np.array(add_feature)).float()
